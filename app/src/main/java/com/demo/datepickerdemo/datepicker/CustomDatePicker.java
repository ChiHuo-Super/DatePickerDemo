...
import com.demo.datepickerdemo.R;
...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    private TextView mTvHourUnit, mTvMinuteUnit, mTvTitle;
    ...
    private void initView() {
        mPickerDialog = new Dialog(mContext, R.style.SelfAdaptionDialog);
     ...
     * 设置标题
     */
    public void setmTvTitleValues(String values) {
        if (mTvTitle != null) mTvTitle.setText(values);
    }
